...
(function() {
	...
	Scroller = function(callback, options) {
		...
		this.options = {
            ...
            /** This configures the 'screen' scale, for determining interaction thresholds */
            scale : 1,
		};
		...
		*/
		...
		doTouchMove: function(touches, timeStamp, scale) {
			...
			// Otherwise figure out whether we are switching into dragging mode now.
				...
				var minimumTrackingForScroll = self.options.locking ? 3 * self.options.scale : 0;
				var minimumTrackingForDrag = 5 * self.options.scale;
